...
impl<Eip4844> From<TxSeismic> for EthereumTypedTransaction<Eip4844> {
...
impl<Eip4844> From<EthereumTxEnvelope<Eip4844>> for EthereumTypedTransaction<Eip4844> {
    fn from(envelope: EthereumTxEnvelope<Eip4844>) -> Self {
        match envelope {
            ...
            EthereumTxEnvelope::Seismic(tx) => Self::Seismic(tx.strip_signature()),
...
impl<Eip4844: ShieldableTransaction> ShieldableTransaction for EthereumTypedTransaction<Eip4844> {
    ...
    for EthereumTypedTransaction<Eip4844>
{
    ...
    fn payload_len_for_signature(&self) -> usize {
        match self {
            ...
            Self::Seismic(tx) => tx.payload_len_for_signature(),
        }
    }
}
...
mod serde_from {
    ...
    //! [`MaybeTaggedTypedTransaction`].
    use crate::{EthereumTypedTransaction, TxEip1559, TxEip2930, TxEip7702, TxLegacy, TxSeismic};
    ...
    impl<Eip4844> From<EthereumTypedTransaction<Eip4844>> for TaggedTypedTransaction<Eip4844> {
        fn from(value: EthereumTypedTransaction<Eip4844>) -> Self {
            match value {
                ...
                EthereumTypedTransaction::Seismic(signed) => Self::Seismic(signed),
            }
        }
    }
}
